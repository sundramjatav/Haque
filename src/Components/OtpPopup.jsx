...
const OtpPopup = ({ isOpen, onClose, onSubmit }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm z-50 p-5">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full">
                ...
                <p className="text-gray-600 text-sm mt-2">Enter the 6-digit OTP sent to your Email</p>
