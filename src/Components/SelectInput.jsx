...
const SelectInput = ({ label, name, value, options, onChange, className = "" ,disabled}) => {
    return (
        <div className="flex flex-col">
            ...
            <select disabled={disabled} value={value} name={name} className={`${className} mt-1 block w-full text-sm  bg-[#ffffff13] backdrop-blur-md border-gray-300 rounded shadow-sm border p-2 outline-none pr-10`} onChange={onChange}>
