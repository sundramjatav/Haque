  ...
  return (
    <div className=" text-white font-sans rounded-xl flex flex-col gap-4">
      <div className='box-border-color p-1 rounded-xl'>
        <div className="background col-span-1 p-4 rounded-xl flex flex-col md:flex-row items-center gap-10 ">
      ...
      <div className='grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:col-span-2  gap-4'>
        {cards.map((card, index) => (
          <div className='box-border-color p-1 rounded-xl'>
            <div
              key={index}
              className="background p-4 rounded-xl flex justify-between items-center"
            >
              <div>
