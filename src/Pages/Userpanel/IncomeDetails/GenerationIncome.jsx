        ...
        <TableComponent
          ...
          renderRow={(item, index) => (
            <>
              ...
              <td className="border-r border-b border-text-white/40  p-2 text-center">{item?.roiPercent}</td>
              <td className="border-b border-r border-text-white/40  p-2 text-center">{item?.earned}</td>
              <td className="border-b  border-text-white/40  p-2 text-center">{new Date(item?.date).toLocaleDateString()}</td>
            </>
          )}
        />
        {loading && (
