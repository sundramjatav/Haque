            ...
            <TableComponent
                ...
                renderRow={(item, index) => (
                    <>
                        ...
                        <td className={`border-r border-b border-text-white/40 p-2 md:p-3 text-center ${item?.status == "Accepted" ? "text-green-500" : "text-red-500"}`}>{item?.status == "Accepted" ? "Solved" : "Pending"}</td>
